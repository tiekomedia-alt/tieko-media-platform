        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-9 space-y-6 sm:space-y-7 lg:border-t lg:border-grid-grey/80 lg:pt-6">
            ...
            <div className="space-y-5 text-slate text-[1.0625rem] sm:text-[1.125rem] leading-relaxed max-w-[720px]">
              ...
              <p className="font-medium text-ink-black border-l-2 border-action-red pl-4 py-1">Tieko connects the systems behind the public result. We help you build correctly, communicate clearly, reach deliberately and improve with evidence.</p>
            </div>
          </div>
        </div>
      </div>
